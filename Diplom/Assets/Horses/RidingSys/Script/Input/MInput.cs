...
{
    [AddComponentMenu("RidingSystem/Input/MInput")]
    public class MInput : MonoBehaviour, IInputSource, IAnimatorListener
    {
        ...
        public Dictionary<string, InputRow> DInputs = new Dictionary<string, InputRow>();
        ...
        protected virtual void OnDisable()
        {
            if (Application.isPlaying && gameObject.activeInHierarchy)
            {
                ...
                {
                    if (input.ResetOnDisable) input.OnInputChanged.Invoke(input.InputValue = false); 
                }
            }
        }
