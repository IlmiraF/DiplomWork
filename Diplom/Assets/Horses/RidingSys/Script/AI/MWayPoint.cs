...
{
    [AddComponentMenu("RidingSystem/AI/Waypoint")]
    public class MWayPoint : MonoBehaviour, IWayPoint
    {
        ...
        public virtual float StopDistance() => stoppingDistance * transform.localScale.y;
        public virtual float SlowDistance() => slowingDistance * transform.localScale.y;
        ...
        public virtual Transform NextTarget()
        {
            ...
            if (next != null && !next.gameObject.activeInHierarchy) next = null;
            ...
            EditorGUILayout.BeginVertical(MTools.StyleGray);
            {
                ...
                UnityEditor.EditorGUILayout.BeginVertical(UnityEditor.EditorStyles.helpBox);
                {
                    ...
                    if (GUILayout.Button("Create Next Waypoint"))
                    {
                        ...
                        nextWayP.GetComponent<MWayPoint>().NextTargets = new List<Transform>();
