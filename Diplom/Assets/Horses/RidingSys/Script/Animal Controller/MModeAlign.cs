...
{
    [AddComponentMenu("RidingSystem/Animal Controller/Mode Align")]
    public class MModeAlign : MonoBehaviour
    {
        ...
        [UnityEngine.Serialization.FormerlySerializedAs("DistanceRadius")]
        ...
        private void AlignAnimalsOnly()
        {
            ...
            {
                if (a == animal || a.ActiveStateID.ID == StateEnum.Death || a.Sleep) continue;
        ...
        private void Align()
        {
            ...
            {
                if (col.transform.root == animal.transform.root) continue;
        ...
        private void StartAligning(Vector3 TargetCenter)
        {
            ...
            if (Distance > 0) StartCoroutine(MTools.AlignTransformRadius(animal.transform, TargetCenter, AlignTime, Distance * animal.ScaleFactor));
        }
