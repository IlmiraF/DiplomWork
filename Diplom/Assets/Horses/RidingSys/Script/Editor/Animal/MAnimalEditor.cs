...
namespace RidingSystem.Controller
{
    ...
    {
        public readonly string version = "Animal Controller [v1.3.1]";
        ...
        SerializedProperty
            ...
            m_SpeedMultiplier, m_UpDown, m_DeltaUpDown, m_StateOn,  m_Sprint, m_ModeOn,
            ...
            lockInput, lockMovement, Rotator, AlignLoop, animalType, RayCastRadius, MainCamera, sleep, m_gravityTime, m_gravityTimeLimit, RootBone,
             ...
             m_CanStrafe, Aimer, m_strafe, OnStrafe, m_StrafeNormalize, m_StrafeLerp, OrientToGround,
        ...
        SerializedProperty
            ...
            ShowLockInputs, ShowMisc, showReferences, showGravity, Editor_EventTabs;
        ...
        private void OnRemoveCallback_Speeds(ReorderableList list)
        {
            ...
            if (list.index == -1 && S_Speed_List.arraySize > 0)
            {
                list.index = 0;
            }
        ...
        private void Draw_Header_State(Rect rect)
        {
            ...
            if (m.states != null && m.states.Count > 0 && SelectedState.intValue != -1)
            {
        ...
        private void AddState(Type selectedState, string name)
        {
            ...
            state.Priority = S_StateList.arraySize;
        ...
        private void OnRemoveCallback_Mode(ReorderableList list)
        {
            ...
            if (list.index == -1 && S_Mode_List.arraySize > 0)
            {
                list.index = 0;
            }
